                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-6">
                                        <section className="space-y-2">
                                            ...
                                            <div className="bg-muted p-4 rounded-2xl space-y-3">
                                                ...
                                                <div className="flex justify-between items-center text-sm">
                                                    ...
                                                    <Badge variant="outline" className="font-bold bg-card">{selectedBug.appVersion || 'Unknown'}</Badge>
                                                </div>
                                            </div>
                                        </section>
                                        ...
                                        {selectedBug.attachments?.length > 0 && (
                                            <section className="space-y-2">
                                                <h3 className="text-xs font-black uppercase tracking-widest text-muted-foreground">Pièces Jointes</h3>
                                                <div className="space-y-2">
                                                    {selectedBug.attachments.map((file, idx) => (
                                                        <a
                                                            ...
                                                            className="flex items-center justify-between p-3 bg-card border border-border rounded-xl hover:border-primary/30 hover:bg-primary/5 transition-all group"
                                                        >
                                                            <div className="flex items-center gap-3 overflow-hidden">
                                                                <div className="p-2 bg-muted rounded-lg group-hover:bg-card">
                                ...
                                <div className="pt-8 border-t border-border flex flex-wrap items-center justify-between gap-4">
                                    <div className="flex flex-wrap gap-2">
                                        <Button
                                            variant="outline"
                                            size="sm"
                                            className="rounded-xl h-10 px-4 font-bold border-border"
