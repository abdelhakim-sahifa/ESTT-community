...
import { getDatabase, ref, get, push, set, update, onValue, remove, query, orderByChild, equalTo } from 'firebase/database';
...
export { app, db, auth, ref, get, push, set, update, onValue, remove, query, orderByChild, equalTo };
