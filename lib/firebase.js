...
import { getDatabase, ref, get, push, set, update, onValue, remove, query, orderByChild, equalTo, increment, serverTimestamp, runTransaction, onDisconnect } from 'firebase/database';
...
export { app, db, auth, storage, storageRef, uploadBytes, getDownloadURL, deleteObject, googleProvider, ref, get, push, set, update, onValue, remove, query, orderByChild, equalTo, increment, serverTimestamp, runTransaction, onDisconnect };
