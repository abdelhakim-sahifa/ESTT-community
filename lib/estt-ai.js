...
- NEVER wrap your entire response in a single code block. This breaks rendering.
- Use proper Markdown: ### for headings, **bold** for emphasis, bullet lists for items.
- For code snippets ONLY, use a fenced code block with a language tag.
- Text, headings, and lists must be plain Markdown OUTSIDE any code block.
- Each code block must contain ONLY executable code — no text, no headings, no explanations inside code blocks.
