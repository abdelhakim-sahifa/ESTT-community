...
- Use proper Markdown formatting. Do NOT wrap the entire response in a single code block.
- For code examples, use fenced code blocks with language tag (like python or c).
- Use ### for section headings, **bold** for emphasis, and bullet lists for multiple items.
- Keep text and code separate — never put markdown headings or lists inside a code block.
- Each code block should contain ONLY code, nothing else.
