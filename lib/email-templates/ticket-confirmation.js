...
export const ticketConfirmationEmail = (ticket, eventName, clubName) => {
    ...
    const content = `
        ...
        <div style="background-color: #ffffff; padding: 20px; border: 1px solid #e2e8f0; border-radius: 6px;">
            ...
            <p style="margin: 5px 0; border-top: 1px solid #eee; padding-top: 10px; margin-top: 10px;"><strong>Participant :</strong> ${ticket.firstName ? `${ticket.firstName} ${ticket.lastName || ''}` : (ticket.userName || 'Participant')}</p>
