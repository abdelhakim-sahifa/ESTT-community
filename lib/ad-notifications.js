            ...
            <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eee; padding: 40px; border-radius: 12px;">
                ...
                <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
                    <p style="margin: 0; font-size: 14px; color: #64748b;">
                        Vous pouvez suivre l'état de vos annonces sur votre <a href="${window.location.origin}/view-ads/dashboard">Tableau de Bord</a>.
                    </p>
                </div>
    ...
    async sendApprovalNotice(userEmail, adTitle, pricing) {
        const html = `
            <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eee; padding: 40px; border-radius: 12px;">
                ...
                <p>Veuillez vous rendre sur votre <a href="${window.location.origin}/view-ads/dashboard">Dashboard</a> pour finaliser le paiement.</p>
            </div>
        `;
