...
export function getProjectStatusClasses(value = '') {
    switch (value) {
        case 'completed':
            return 'border-slate-200 bg-slate-100 text-slate-700 dark:border-slate-500/40 dark:bg-slate-500/15 dark:text-slate-300';
        case 'closed':
            return 'border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-500/40 dark:bg-amber-500/15 dark:text-amber-300';
        case 'open':
        default:
...
export function getDifficultyClasses(value = '') {
    switch (value) {
        ...
        case 'intermediate':
            return 'border-sky-200 bg-sky-50 text-sky-700 dark:border-sky-500/40 dark:bg-sky-500/15 dark:text-sky-300';
        case 'beginner':
        default:
